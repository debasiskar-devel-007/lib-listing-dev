...
export declare class ListingComponent implements OnInit, OnDestroy {
    ...
    openBottomSheetForSearch(data: any, index: any): void;
    clearButtonSearchChips(bs: any, i: any, item: any, j: any): void;
...
export declare class ModalForButtomSearch {
    private bnottoRef;
    data: any;
    ...
    reset(): void;
    searchByKeyword(value: any): void;
    close(): void;
}
