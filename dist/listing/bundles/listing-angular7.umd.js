                            ...
                            if (this_1.formdataval.fields[g].multiple == null) {
                                ...
                                if (files[i].type == 'image/png' || files[i].type == 'image/jpg' || files[i].type == 'image/jpeg') {
                                     ...
                                     */function (event) {
                                        ...
                                        if (_this.formdataval.fields[g].aspectratio != null && _this.formdataval.fields[g].aspectratio.length > 0) {
                                ...
                                console.log(this_1.formdataval.fields[g], 'this.formdataval.fields[g]++ >M');
                                ...
                                if (files[i].type == 'image/png' || files[i].type == 'image/jpg' || files[i].type == 'image/jpeg') {
                                     ...
                                     */function (event) {
                                        ...
                                        if (_this.formdataval.fields[g].aspectratio != null && _this.formdataval.fields[g].aspectratio.length > 0) {
                                            console.log(_this.formdataval.fields[g].aspectratio, 'ratio+=====>');
