...
var ListingComponent = /** @class */ (function () {
    function ListingComponent(_apiService, dialog, bottomSheet, fb, router, resolver, container, _http, sanitizer, _snackBar, _elementRef, observableService) {
        ...
        function () {
            ...
            if (_this.pageChangeValue > _this.pageCountArray.length) {
                _this._snackBar.openFromComponent(SnackbarComponent, {
                    duration: 6000,
                    data: { errormessage: 'Sorry!! Page number is out of range.' }
                });
            }
            if (_this.pageCountArray.length > _this.pageChangeValue) {
