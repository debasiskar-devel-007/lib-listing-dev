    ...
    function (value) {
        ...
        if (this.searchVal != null && this.searchVal != '') {
            ...
            function (res) {
                ...
                var result = res;
                if (result.status == 'success') {
                    _this.buttonSearchData.items.value = [];
                    _this.loading_flag = false;
                    result = result.res.slice(0, 12);
                    _this.buttonSearchData.items.value = result;
